let button_new_publication_secondary = document.getElementById(
  "button_new_publication_secondary"
);
let button_close_new_publication_secondary = document.getElementById(
  "close_window_new_publication"
);
let window_open = false;
let capa_principal_new_publication = document.getElementById(
  "capa_principal_new_publication"
);
let window_new_publication = document.getElementById("window_new_publication");
let img_preview_element = document.getElementById("preview_img_articulo");
...
let dropzone_new_publication = document.getElementById(
  "dropzone_new_publication"
);
let input_imagenes_new_publication = document.getElementById(
  "input_imagenes_new_publication"
);
...
input_imagenes_new_publication.addEventListener("change", (e) => {
  let p = dropzone_new_publication.querySelector("p");
  
  if (input_imagenes_new_publication.files.length > 0) {
    console.log(input_imagenes_new_publication.files);
    preview_img(input_imagenes_new_publication.files[0],img_preview_element)
    p.textContent =
      input_imagenes_new_publication.files.length +
...
let descripcion_publicacion = document.getElementById(
  "descripcion_publicacion"
);
let contador_desc_new_publication = document.getElementById(
  "contador_desc_new_publication"
);

descripcion_publicacion.addEventListener("input", () => {
  contador_desc_new_publication.textContent =
    descripcion_publicacion.value.length;
});
...
dropzone_new_publication.addEventListener("drop", (e) => {
  ...
  preview_img(e.dataTransfer.files[0],img_preview_element)
